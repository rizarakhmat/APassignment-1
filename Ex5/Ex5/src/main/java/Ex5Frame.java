...
public class Ex5Frame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ptint text here (not more 32 char)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ex5Frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
